...
#
# aiscalator documentation build configuration file, created by
...
version = aiscalator.__version__
# The full version, including alpha/beta/rc tags.
release = aiscalator.__version__
...
htmlhelp_basename = 'aiscalatordoc'
